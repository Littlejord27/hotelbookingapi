...
@Entity
@Table(name = "booking", schema = "fantastix")
@NamedQueries({
        @NamedQuery(
...
{
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "booking_id_seq_name")
    @SequenceGenerator(name = "booking_id_seq_name", sequenceName = "fantastix.booking_id_seq", allocationSize = 1)
